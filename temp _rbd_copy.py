...
def update_plot(fb_time,cycle,cycle_num):
    ...
    global xdata,ydata,ln,fig,plt_color,pins
...
def Acctuate():
    ...
    global HOST_Version,reset,Var_plot,pins,acc_over,plt_data
...
def Deselect():
   global lbl_status , lblHCC,reset,Var_all,Var,Var_V,Var_H
   scan_ports()
   reset=True
   Var_all.set(0)
...
btnAct=t.Button(f3 ,bd=2, command=Acctuate,pady=4,relief=t.RAISED,highlightthickness=1)
#btnAct=t.Button(f3,font=('arial',8,'bold'),text="ACTUATE",bg='grey93',activebackground='#b3e6ff',fg="Black",bd=3,width=8,command=Acctuate,pady=2,relief=t.RAISED)
...
btnClr=t.Button(f3  ,bd=2, command=Deselect,pady=0,relief=t.RAISED,highlightthickness=2)
...
btnPlt=t.Button(f3  ,bd=2, command=post_plot,pady=0,relief=t.RAISED,highlightthickness=1)
#btnClr=t.Button(f3,font=('arial',8,'bold'),text="CLEAR",bg='grey93',activebackground='#b3e6ff',fg="Black",bd=3,width=8,command=Deselect,pady=2,relief=t.RAISED)
...
#=============================btn_hold===========================#
btnhold=t.Button(f3  ,bd=2, command=post_plot,pady=0,relief=t.RAISED,highlightthickness=1)
#btnClr=t.Button(f3,font=('arial',8,'bold'),text="CLEAR",bg='grey93',activebackground='#b3e6ff',fg="Black",bd=3,width=8,command=Deselect,pady=2,relief=t.RAISED)
button_image(btnhold,"Data-Scatter-Plot-icon.png")#"icons8-play-graph-report (1).png") #13
...
lbl_status.place(x=int(round(w*.92)),y=1)

lbl_Test= t.Label(f3,font=('arial',8,'bold'),text="Status", width=7,anchor="center",pady=4,relief=t.FLAT,justify='center')
lbl_Test.place(x=int(round(w*.86)),y=1)

ttk.Separator(f3,orient=HORIZONTAL).place(x=0,y=30, relwidth=1)

lbl_Counter= t.Label(f3,font=('arial',8,'bold'),text="Counter", width=7,anchor="center",pady=1,relief=t.FLAT,justify='center')
lbl_Counter.place(x=int(round(w*.1)),y=300)
lbl_Counter_show= t.Label(f3,font=('arial',8,'bold'),text="  ", width=3,bd=1,anchor="center",pady=2,relief=t.SUNKEN,justify='center')
...
Var_plot= IntVar()
plot_chk= Checkbutton(f3 ,text="Plot", variable = Var_plot,\
                                 onvalue =1, offvalue = 0, \
                                 bg='grey52',fg='#300302')
plot_chk.place(x=int(round(w*.4)+65),y=293)
